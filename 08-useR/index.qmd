...
- Add chapters covering additional undergraduate computing courses

- Update chapters based on student questions, package updates, etc.

- This summer: Title II compatibility checks and graduate student editing
...
![The state of the global environment at the time the function is called (that is, the state of the calling environment) can change the results of the function](function-scope-calling-environment.png)
...
- Without SAS, build the textbook via GitHub Actions?
...
- Balance between amount of code/output and centering important content
...
# Teaching R and Python Together {.center}

## Why?

- Students need to learn the concepts (look up syntax)
- Data science/stat languages change! (Julia? JavaScript? Python? Ruby?)
- Reading documentation and looking for help is a **critical skill**

## How?

- Assignments ask for basic tasks in both languages

- Harder tasks -- pick the best/easiest language for the task

- Bonus points (sometimes) for doing the task in both languages

- 2 Languages keep more computationally advanced students engaged    
Students with less experience focus on mastering one of the languages

- Exams -- any language for code, focus on concepts/sketching/planning